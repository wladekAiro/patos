package com.wladek.patos.common;

import com.wladek.patos.TestConfiguration;
...
public class HibernateSchemaGeneratorTest {
    ...
    Configuration cfg;
    PostgreSQL9Dialect dialect = new PostgreSQL9Dialect();
    ...
    public void setup() {
        ...
        cfg.setProperty("hibernate.connection.url", "jdbc:postgresql://localhost:5432/patos");
